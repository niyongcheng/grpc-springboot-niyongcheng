...
public final class RouteGuideGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.niyongcheng.examples.routeguide.Point,
      com.niyongcheng.examples.routeguide.Feature> getGetFeatureMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetFeature",
      requestType = com.niyongcheng.examples.routeguide.Point.class,
      responseType = com.niyongcheng.examples.routeguide.Feature.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.niyongcheng.examples.routeguide.Point,
      com.niyongcheng.examples.routeguide.Feature> getGetFeatureMethod() {
    io.grpc.MethodDescriptor<com.niyongcheng.examples.routeguide.Point, com.niyongcheng.examples.routeguide.Feature> getGetFeatureMethod;
      ...
      synchronized (RouteGuideGrpc.class) {
        if ((getGetFeatureMethod = RouteGuideGrpc.getGetFeatureMethod) == null) {
          RouteGuideGrpc.getGetFeatureMethod = getGetFeatureMethod =
              io.grpc.MethodDescriptor.<com.niyongcheng.examples.routeguide.Point, com.niyongcheng.examples.routeguide.Feature>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetFeature"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.niyongcheng.examples.routeguide.Point.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.niyongcheng.examples.routeguide.Rectangle,
      com.niyongcheng.examples.routeguide.Feature> getListFeaturesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListFeatures",
      requestType = com.niyongcheng.examples.routeguide.Rectangle.class,
      responseType = com.niyongcheng.examples.routeguide.Feature.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.niyongcheng.examples.routeguide.Rectangle,
      com.niyongcheng.examples.routeguide.Feature> getListFeaturesMethod() {
    io.grpc.MethodDescriptor<com.niyongcheng.examples.routeguide.Rectangle, com.niyongcheng.examples.routeguide.Feature> getListFeaturesMethod;
      ...
      synchronized (RouteGuideGrpc.class) {
        if ((getListFeaturesMethod = RouteGuideGrpc.getListFeaturesMethod) == null) {
          RouteGuideGrpc.getListFeaturesMethod = getListFeaturesMethod =
              io.grpc.MethodDescriptor.<com.niyongcheng.examples.routeguide.Rectangle, com.niyongcheng.examples.routeguide.Feature>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListFeatures"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.niyongcheng.examples.routeguide.Rectangle.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.niyongcheng.examples.routeguide.Feature.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.niyongcheng.examples.routeguide.Point,
      com.niyongcheng.examples.routeguide.RouteSummary> getRecordRouteMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RecordRoute",
      requestType = com.niyongcheng.examples.routeguide.Point.class,
      responseType = com.niyongcheng.examples.routeguide.RouteSummary.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<com.niyongcheng.examples.routeguide.Point,
      com.niyongcheng.examples.routeguide.RouteSummary> getRecordRouteMethod() {
    io.grpc.MethodDescriptor<com.niyongcheng.examples.routeguide.Point, com.niyongcheng.examples.routeguide.RouteSummary> getRecordRouteMethod;
    if ((getRecordRouteMethod = RouteGuideGrpc.getRecordRouteMethod) == null) {
      synchronized (RouteGuideGrpc.class) {
        if ((getRecordRouteMethod = RouteGuideGrpc.getRecordRouteMethod) == null) {
          RouteGuideGrpc.getRecordRouteMethod = getRecordRouteMethod =
              io.grpc.MethodDescriptor.<com.niyongcheng.examples.routeguide.Point, com.niyongcheng.examples.routeguide.RouteSummary>newBuilder()
  ...
  private static volatile io.grpc.MethodDescriptor<com.niyongcheng.examples.routeguide.RouteNote,
      com.niyongcheng.examples.routeguide.RouteNote> getRouteChatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RouteChat",
      requestType = com.niyongcheng.examples.routeguide.RouteNote.class,
      responseType = com.niyongcheng.examples.routeguide.RouteNote.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.niyongcheng.examples.routeguide.RouteNote,
      com.niyongcheng.examples.routeguide.RouteNote> getRouteChatMethod() {
    io.grpc.MethodDescriptor<com.niyongcheng.examples.routeguide.RouteNote, com.niyongcheng.examples.routeguide.RouteNote> getRouteChatMethod;
    if ((getRouteChatMethod = RouteGuideGrpc.getRouteChatMethod) == null) {
      synchronized (RouteGuideGrpc.class) {
        if ((getRouteChatMethod = RouteGuideGrpc.getRouteChatMethod) == null) {
          RouteGuideGrpc.getRouteChatMethod = getRouteChatMethod =
              io.grpc.MethodDescriptor.<com.niyongcheng.examples.routeguide.RouteNote, com.niyongcheng.examples.routeguide.RouteNote>newBuilder()
  ...
  public static abstract class RouteGuideImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getFeature(com.niyongcheng.examples.routeguide.Point request,
        io.grpc.stub.StreamObserver<com.niyongcheng.examples.routeguide.Feature> responseObserver) {
     ...
     * </pre>
     */
    public void listFeatures(com.niyongcheng.examples.routeguide.Rectangle request,
        io.grpc.stub.StreamObserver<com.niyongcheng.examples.routeguide.Feature> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.niyongcheng.examples.routeguide.Point> recordRoute(
        io.grpc.stub.StreamObserver<com.niyongcheng.examples.routeguide.RouteSummary> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.niyongcheng.examples.routeguide.RouteNote> routeChat(
        io.grpc.stub.StreamObserver<com.niyongcheng.examples.routeguide.RouteNote> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.niyongcheng.examples.routeguide.Point,
                com.niyongcheng.examples.routeguide.Feature>(
                  this, METHODID_GET_FEATURE)))
          .addMethod(
            getListFeaturesMethod(),
            asyncServerStreamingCall(
              new MethodHandlers<
                com.niyongcheng.examples.routeguide.Rectangle,
                com.niyongcheng.examples.routeguide.Feature>(
          ...
          .addMethod(
            ...
            asyncClientStreamingCall(
              new MethodHandlers<
                com.niyongcheng.examples.routeguide.Point,
                com.niyongcheng.examples.routeguide.RouteSummary>(
                  this, METHODID_RECORD_ROUTE)))
          .addMethod(
            getRouteChatMethod(),
            asyncBidiStreamingCall(
              new MethodHandlers<
                com.niyongcheng.examples.routeguide.RouteNote,
                com.niyongcheng.examples.routeguide.RouteNote>(
  ...
  public static final class RouteGuideBlockingStub extends io.grpc.stub.AbstractBlockingStub<RouteGuideBlockingStub> {
     ...
     * </pre>
     */
    public com.niyongcheng.examples.routeguide.Feature getFeature(com.niyongcheng.examples.routeguide.Point request) {
     ...
     * </pre>
     */
    public java.util.Iterator<com.niyongcheng.examples.routeguide.Feature> listFeatures(
  ...
  public static final class RouteGuideFutureStub extends io.grpc.stub.AbstractFutureStub<RouteGuideFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.niyongcheng.examples.routeguide.Feature> getFeature(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_FEATURE:
          serviceImpl.getFeature((com.niyongcheng.examples.routeguide.Point) request,
              (io.grpc.stub.StreamObserver<com.niyongcheng.examples.routeguide.Feature>) responseObserver);
          break;
        case METHODID_LIST_FEATURES:
          serviceImpl.listFeatures((com.niyongcheng.examples.routeguide.Rectangle) request,
              (io.grpc.stub.StreamObserver<com.niyongcheng.examples.routeguide.Feature>) responseObserver);
          break;
        default:
  ...
  private static abstract class RouteGuideBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.niyongcheng.examples.routeguide.RouteGuideProto.getDescriptor();
    }
